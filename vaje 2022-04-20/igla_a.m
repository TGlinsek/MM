function [seka] = igla_a()
    % met igle, a) naloga

    % verjetnost, da igla seka črto, če l = t: P = 2/pi
    ...
    y_0 = rand();  % ta vrednost bo razdalja do zgornje črte, ki je lahko 
    % kvečjemu 1
    
    
    % ali igla seka zgornjo črto?
    % 1 je razdalja od težišča do konice
    
    zgornja_konica = y_0 - y/sqrt(x^2 + y^2);
